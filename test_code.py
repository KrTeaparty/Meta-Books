...
def test_apenai(API_KEYS: dict, content: str):
    ...
    print(ans2)
#"You are a helpful assistant who is good at translating."
    messages = [
        {
            "role": "system",
...
def test_karlo(API_KEYS: dict, content: str):
    ...
    prompt = ", concept art, 8K, ultra-detailed, illustration"
...
if __name__ == '__main__':
    with open('./metabooks/bookreport/API_KEYS.json', 'r') as f:
